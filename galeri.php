                ...
                <!-- Post preview-->
                 ...
                 <div class="container">
                    ...
                    <?php
                        ...
                        $cek=$db->prepare("SELECT * FROM `galeri` WHERE  `aktif` = :aktif ORDER BY  `id` DESC");
                        $cek->bindValue(":aktif",1,PDO::PARAM_INT);
                        $cek->execute();

                        while($row=$cek->fetch(PDO::FETCH_ASSOC)){
                        ?>
                         <div class="col-md-3 col-sm-4 col-xs-6"><img width="300px" height="300px" src="<?= $row["image"] ?>" /></div>
                         <?php
                             }
                        ?>
                     </div>
