...
<head>
    ...
    <title>Kategori Duzenle | Admin Panel</title>
...
<body>
        ...
        <?php
             ...
             $cek=$db->prepare("SELECT * FROM `kategori` WHERE `id` =:id ");
            ...
            if(@$_POST["submit"]){
                ...
                $guncelle=$db->prepare("UPDATE `kategori` SET `kategori_adi`= :kategori_adi , `aktif`= :aktif  WHERE `id` =:id ");
                                ...
                                <div class="col-lg-6">
                                    <form role="form" action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="kategori_adi" value="<?= $row["kategori_adi"] ?>" placeholder="Kategori Giriniz" >
                                        </div>
