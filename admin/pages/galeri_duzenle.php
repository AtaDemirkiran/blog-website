...
<head>
    ...
    <title>Galeri Duzenle | Admin Panel</title>
...
<body>
        ...
        <?php
             ...
             $cek=$db->prepare("SELECT * FROM `galeri` WHERE `id` =:id ");
                ...
                if($filename!=''){
                    ...
                    $extension_arr=array("jpg","jpeg","png","gif");
                        if(in_array($extension,$extension_arr)){
                            ...
                            $guncelle=$db->prepare("UPDATE `galeri` SET `baslik`= :baslik,`image`= :image , `aktif`= :aktif  WHERE `id` =:id ");
                                ...
                                <div class="col-lg-6">
                                    <form role="form" action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                             <label>Blog Resim</label> <br>
                                             <img src="<?= $row["image"]  ?>" width="150px" height="150px" alt="">
