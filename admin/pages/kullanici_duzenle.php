...
<head>
    ...
    <title>Kullanıcı Duzenle | Admin Panel</title>
...
<body>
        ...
        <?php
             ...
             $cek=$db->prepare("SELECT * FROM `kullanici` WHERE `id` = :id ");
            ...
            if(@$_POST["submit"]){
                ...
                $guncelle=$db->prepare("UPDATE `kullanici` SET `username`= :username, `password`= :password , `aktif`= :aktif  WHERE `id` = :id ");

                $guncelle->bindValue(":username",$username,PDO::PARAM_STR);
                $guncelle->bindValue(":password",$password,PDO::PARAM_STR);
