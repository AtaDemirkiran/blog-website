...
<body>
    ...
    <?php
        if(@$_POST["submit"]){
             ...
             $cek=$db->prepare("SELECT * FROM `kullanici`");
             $cek->execute();
            ...
            if($_POST["username"]==$row["username"] && $md5sifre==$row["password"]){
                ...
                echo '<p style="text-align:center;color:red;">Kullanici adi veya parola yanlış</p>';
                return false;
            }
        ...
        if(@$_GET["i"]=="cikis"){
            echo '<p style="text-align:center;color:green;">Basarıyla cıkıs yaptınız</p>';

        }elseif(@$_GET["i"]=="hack"){
            echo '<p style="text-align:center;color:red;">Giriş yapmalısınız</p>';
        }
