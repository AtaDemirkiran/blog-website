...
<head>
    ...
    <title>İletisim Bilgi Ekle | Admin Panel</title>
...
<body>
        ...
        <?php
                if(@$_POST["submit"]){
                        ...
                        $ekle=$db->prepare('INSERT INTO `iletisimbilgileri` (`tel1`,`tel2`,`mail`,`adres`,`aktif`) VALUES
                        (:tel1, :tel2, :mail, :adres, :aktif) ');
                    
                        $ekle->bindValue(":tel1",$tel1,PDO::PARAM_STR);
                        $ekle->bindValue(":tel2",$tel2,PDO::PARAM_STR);
                        $ekle->bindValue(":mail",$mail,PDO::PARAM_STR);
                        $ekle->bindValue(":adres",$adres,PDO::PARAM_STR);
                                ...
                                <div class="col-lg-6">
                                    <form role="form" action="" method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="tel1" placeholder="Telefon 1 Giriniz" required>
                                        </div>

                                        <div class="form-group">
                                            <label>Telefon 2</label>
                                            <input class="form-control" name="tel2" placeholder="Telefon 2 Giriniz" >
                                        </div>
                                        <div class="form-group">
                                            <label>E-mail </label>
                                            <input class="form-control" type="email" name="mail" placeholder="E-mail Giriniz" required >
                                        </div>
                                        <div class="form-group">
                                            <label>Adres</label>
                                            <textarea class="form-control" name="adres" id="mytextarea" rows="3"></textarea>
                                        </div>
