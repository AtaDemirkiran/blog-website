                    ...
                    if($filename!=''){
                        ...
                        if(in_array($extension,$extension_arr)){
                            ...
                            $image="data::image/".$extension.";base64,".$image_base64;
                                ...
                                $ekle=$db->prepare('INSERT INTO `urunler` (`urun_adi`,`kategori_adi`,`urun_baslik`,`urun_detay`,`image`,`aktif`) VALUES
                                (:urun_adi,:kategori_adi,:urun_baslik,:urun_detay,:image,:aktif) ');
                            
                                $ekle->bindValue(":urun_adi",$urun_adi,PDO::PARAM_STR);
                                $ekle->bindValue(":kategori_adi",$kategori_adi,PDO::PARAM_STR);
                                $ekle->bindValue(":urun_baslik",$urun_baslik,PDO::PARAM_STR);
                                $ekle->bindValue(":urun_detay",$urun_detay,PDO::PARAM_STR);
                                ...
                                <div class="col-lg-6">
                                    <form role="form" action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="urun_adi" placeholder="Başlık Giriniz" >
                                        </div>

                                        <div class="form-group">
                                            <label>Ürün Başlık</label>
                                            <input class="form-control" name="urun_baslik" placeholder="Alt Başlık Giriniz" >
                                        </div>

                                        <div class="form-group">
                                            <label>Ürün Detay</label>
                                            <textarea class="form-control" name="urun_detay" id="mytextarea" rows="3"></textarea>
                                        </div>
                                        <div class="form-group">
